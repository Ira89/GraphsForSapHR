...
public class UnitTest {
    ...
    private void testGraphs() {
        ...
        Graph actualGraph = new Graph(1, "graph", "dddfff", 11, "FL11");
        actualGraph.setCounter(0);
        actualGraph.startGenerating(169, DAY_OF_MONTH, shortDayAndHolidays, dayHours, nightHours);
    ...
    private void testDiurnalGraphs() {
        ...
        actualGraph.startGenerating(170, DAY_OF_MONTH, shortDayAndHolidays, dayHours, nightHours);
    ...
    private void testStandardGraphs() {
        ...
        Graph actualGraph = new GraphStandard(1, "standard", "dddddff", 8, "NORM");
        actualGraph.setCounter(1);
        actualGraph.startGenerating(169, DAY_OF_MONTH, shortDayAndHolidays, dayHours, nightHours);
