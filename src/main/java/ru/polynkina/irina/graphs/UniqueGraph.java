...
public class UniqueGraph extends FiveDayGraph {
    ...
    // Для уникального графика ставим 0 часов на выходные и перенесенные праздничные
    @Override
    ...
    // ----------------------------------------------- step 4 ----------------------------------------------------------
    // На все незаполненные дни ставим стандартное или уникальное рабочее время
    ...
    // ----------------------------------------------- step 5 ----------------------------------------------------------
    // Ставим или стандартное время, уникальное время, или выходной
    @Override
